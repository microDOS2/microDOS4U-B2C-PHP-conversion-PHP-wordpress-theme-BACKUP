    ...
    <main>
        ...
        <section class="section" id="dose" style="padding-top: 32px; padding-bottom: 32px;">
            <div class="container">
                ...
                <div id="dosage-section" class="card" style="margin-bottom: 18px; text-align: center;">
                    <h3 style="margin-bottom: 6px;"><a href="#dosage-section" style="color: #fff; text-decoration: none;">Dosage Guide →</a></h3>
