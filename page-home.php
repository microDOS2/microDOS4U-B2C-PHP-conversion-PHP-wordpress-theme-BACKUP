    ...
    <div class="container">
        ...
        <div class="pricing-grid">
            <div class="pricing-card text-center">
                ...
                <a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>" class="btn btn-primary w-full">Start Here</a>
            </div>
            <div class="pricing-card text-center">
                <h3>Explorer Box</h3>
                ...
                <a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>" class="btn btn-primary w-full">Subscribe</a>
            </div>
            <div class="pricing-card text-center">
                <h3>Optimizer Box</h3>
