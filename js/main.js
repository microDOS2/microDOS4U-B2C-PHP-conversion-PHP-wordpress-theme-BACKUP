...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Password Eye Toggle (all pages)
    initPasswordToggle();
    // Re-run on DOM changes (for dynamically added password fields)
    var pwdObserver = new MutationObserver(function(mutations) {
        var hasPasswordField = mutations.some(function(m) {
        ...
        if (hasPasswordField) initPasswordToggle();
    });
    pwdObserver.observe(document.body, { childList: true, subtree: true });
