 ...
 * Properly handles WooCommerce pages (My Account, Cart, Checkout).
 * 
 * @package microDOS4U
 */
...
<section class="py-20" style="background-color: rgba(10, 5, 20, 0.7) !important; min-height: 60vh;">
    <div class="container mx-auto px-4 sm:px-6" style="max-width: 1100px;">
        ...
        <?php if (is_account_page() || is_cart() || is_checkout()) : ?>
            <!-- WooCommerce pages: render without custom wrapper so shortcodes work fully -->
        ...
        <?php else : ?>
            <!-- Standard WordPress pages: show title and content -->
