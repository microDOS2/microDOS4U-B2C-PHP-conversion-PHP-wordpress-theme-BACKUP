...
<section class="hero py-5">
    ...
    <div class="container">
        <div class="hero-content">
            <h1 class="hero-title gradient-text">Real Stories</h1>
            <p class="hero-subtitle">
                Discover how our community is using microDOS(2) to enhance creativity, focus, and emotional well-being.
            </p>
        </div>
    </div>
</section>
...
<section class="py-5">
    <div class="container">
        <div class="features-grid">
            ...
            <div class="card">
                <h3>Mateo's Method</h3>
                <p>A journey of self-discovery and enhanced creativity through precise microdosing protocols.</p>
                <a href="#" class="btn btn-secondary mt-2">Read Mateo's Story</a>
            </div>
        </div>
    </div>
</section>
