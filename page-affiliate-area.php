...
<?php
            ...
            <?php if ($is_pending_affiliate) : ?>
                <!-- PENDING AFFILIATE: Show ONLY the pending message -->
...
<?php
                ...
                <?php elseif (function_exists('affwp_is_affiliate') && affwp_is_affiliate()) : 
                    ...
                    <?php endif; // active check handled above by $is_pending_affiliate ?>
                ...
                <div class="mb-10 p-6 rounded-lg" style="background-color: #0a0514; border: 1px solid #1f2b47;">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-slate-400 text-sm">Yes! You can share your referral link on any platform &mdash; Instagram, TikTok, Twitter/X, Facebook, blogs, email newsletters, Discord, Reddit, and more. Just follow our <a href="/affiliate-terms" style="color: #ff66c4; text-decoration: underline;">Affiliate Terms</a>.</p>
                        </div>
                    </div>
                </div>
            <?php endif; // end $is_pending_affiliate check ?>
