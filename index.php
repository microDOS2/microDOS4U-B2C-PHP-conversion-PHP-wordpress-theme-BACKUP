...
<section class="hero py-5">
    ...
    <div class="container">
        <div class="hero-content">
            <h1 class="hero-title">
                Precision Psychedelics,<br>Simplified.
            </h1>
    ...
    <div class="container">
        ...
        <div class="pricing-grid">
            <div class="pricing-card text-center">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/trial-pack.png" alt="Trial Pack" class="mx-auto mb-2 rounded" style="width:120px;" onerror="this.style.display='none'">
